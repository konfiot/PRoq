...
subprocess.call(["../picospeaker/picospeaker", "-l", "fr-FR", "Temps prevu pour aujourd'hui : " + weather_string + ". Vous avez "+ str(unread) + "Messages non lus. " + str(i) + " evenement aujourd'hui : " + rdv])
