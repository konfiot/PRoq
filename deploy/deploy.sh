...
echo "Copying files"
scp -r -i id_rsa -o StrictHostKeyChecking --exclude system.img --exclude arch.img --exclude arch.img.bz2 --exclude kernel-qemu --exclude id_rsa  --exclude id_rsa_sourceforge -P 5555 ./* root@localhost:./
